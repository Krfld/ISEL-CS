...
assert citala_espartana(
    TEXTO_CLARO, 4) == 'AENDBROAASDSTAETASSELTFRHEIMARLOCAAPOLDIMUELOGIASARSPRO'

# ii    AMEDRPBOREOIASASDLTPLFAAAEUISSLRGLTHSAAEAARDRCSNEMOTOIO
print(citala_espartana(TEXTO_CLARO, 6))
assert citala_espartana(
    TEXTO_CLARO, 6) == 'AMEDRPBOREOIASASDLTPLFAAAEUISSLRGLTHSAAEAARDRCSNEMOTOIO'


# EX 1  AAERNLDOBCRAOAAPAOSLDDSITMAUEETLAOSGSIEALSTAFRRSHPERIOM
print(citala_espartana(TEXTO_CLARO, 8))
assert citala_espartana(
    TEXTO_CLARO, 8) == 'AAERNLDOBCRAOAAPAOSLDDSITMAUEETLAOSGSIEALSTAFRRSHPERIOM'

# EX 2  AHSSUDADMSBAPTGEDAOACEEASESPTORRRFITIAMSANIRELLOALOLORA
print(citala_espartana(TEXTO_CLARO, 10))
assert citala_espartana(
    TEXTO_CLARO, 10) == 'AHSSUDADMSBAPTGEDAOACEEASESPTORRRFITIAMSANIRELLOALOLORA'
